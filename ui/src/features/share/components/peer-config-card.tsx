...
export default function PeerConfigCard({ isLoading, config }: PeerConfigCardProps) {
  ...
  return (
    <div className='flex flex-col justify-between rounded-[28px] border border-white/10 bg-gradient-to-b from-white/[0.08] to-white/[0.02] backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-6 sm:p-7 relative overflow-hidden transition-all duration-300 md:col-span-2 lg:col-span-1'>
